    ...
    public class MapGenerator : MonoBehaviour
    {
        ...
        public void GenerateMap()
        {
            ...
            for (int x = 0; x < currentMap.mapSize.x; x++)
            {
                for (int y = 0; y < currentMap.mapSize.y; y++)
                {
                    Vector3 tilePosition = CoordToPosition(x, y); //new Vector3(-mapSize.x / 2 + 0.5f + x, 0, -mapSize.y/2 + 0.5f + y);
        ...
        bool MapIsFullyAccesible(bool[,] obstacleMap, int currentObstacleCount)
        {
            ...
            //porównanie liczby aktualnie postawionych przeszkód, razem z obecną, do liczby wykrytych floodfilem
